        ...
        {items.map((item, index) => (
          ...
          >
            <NavLink
              to={item.to}
              className={({ isActive }) =>
                ` ${isSidebarOpen ? "w-[240px]" : "w-[50px]"} flex items-center px-3 py-2 rounded-lg transition-colors duration-200 ${
                  isActive
                    ? 'bg-blue-500 bg-opacity-20 text-white border-l-4 border-blue-500'
                    : 'hover:bg-gray-700'
                }`
              }
